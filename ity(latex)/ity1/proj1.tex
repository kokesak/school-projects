...
Smíšená sazba má o něco volnější pravidla. Klasická hladká sazba se doplňuje o další řezy písma pro zvýraznění důležitých pojmů. Existuje \uv{pravidlo}:\par

\begin{quotation}
    {\fontfamily{pag}\selectfont Čím více druhů,} \textsc{řezů}, {\tiny velikostí}, barev písma \underline{a jiných efektů} použijeme, tím \textit{\large{profesionálněji}} bude dokument vypadat. Čtenář tím bude vždy \scshape{nadšen}!
\end{quotation}

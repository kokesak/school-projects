...
<div class="image-container set-full-height" style="background-image: url('assets/img/main_screen.jpg')">
    <div class="container" >
        ...
        <div class="alert alert-success collapse" id="deleting_alert">   <!-- collapse hide alert ath the begining -->
            ...
            <input type='button' class='btn-dark btn-fill text-success pull-right' onclick='location.replace("del_user.php?login=<?php echo $_SESSION["user"] ?>");' name='confirm_delete_acc' value='YES'/>
        ...
        <div class="col-sm-7"> 
            <div class="form-group has-success">
                <form action="account_update.php" method="get">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control" name="Level">
                                <?php
                                    $select_type = checkUser($_SESSION['type']);
                                ?>
                ...
                <br>
                <br>
                <?php if( $_SESSION['user'] == $data['login']) { ?>
                <Input type='button' 
                        class='btn btn-fill btn-warning btn-wd btn-sm pull-right'
                        style="margin:5px;" 
                        onclick="location.replace('user_courses.php');"
                        name='course_btn' 
                        value='My course'/> 
                        <br>
                <br>
                ...
                <br>
                <Input type='button' 
                        class='btn btn-fill btn-danger btn-wd btn-sm pull-right'
                        style="margin:5px;" 
                        onclick="$('#deleting_alert').show('fade');"
                        name='login_btn' 

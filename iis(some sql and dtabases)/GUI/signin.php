    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8">  <!--  White screen length  -->
                ...
                <div class="alert alert-danger collapse" id="log_in_alert">   <!-- collapse hide alert ath the begining -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">          <!--     Loging/password shift     -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="log_in_error" class="text-danger hide"> <!--     Error login input     -->
                                        ...
                                        <div id="password_error" class="text-danger hide"> <!--     Error password input     -->
